...
# Build model
model = RNN_model(embedding_size).to(device)
...
torch.save(model,'rnn_GloVe.ckpt')
data = {"Epoch":num_epochs, "Train_loss": train_loss, "Train_acc": train_acc, "Batch_size": batch_size, "Optimizer": "Adam", "Learning_rate": lr, "Vacobulary_size":vocab_size, "Embedding_size":embedding_size, "Sequence_length": sequence_length}
torch.save(data, 'rnn_GloVe_checkpoint.pth.tar')

...
# Download UCF101 from base_directory
...
# Load a single frame randomly from the video (saved as hdf5 instead of avi)
def loadFrame(args):
...
# Load a continuous sequence of frames in video (num_of_frames parameter)
def loadSequence(args):
    ...
    curr_h = 240
    height = width = 224
    num_of_frames = 16 # This is different, because here we extract a continuous sequence of frames
